...
public:
  ...
  ~LegacyA() {
    cout << "LegacyA::destructor" << endl;
  }
  void doThis() {
    cout << "LegacyA::doThis()" << endl;
  }
};
...
public:
  ~LegacyB() {
    cout << "LegacyB::destructor" << endl;
  }
  void doThat() {
    cout << "LegacyB::doThat()" << endl;
  }
};
...
class LegacyC {
  public:
  ~LegacyC() {
    cout << "LegacyC::destructor" << endl;
  }
  void doTheOther() {
    cout << "LegacyC::doTheOther()" << endl;
  }
};
...
template <class T>
class AdapterMapper: public AdapterInterface {
public:
